...
import org.visual.model.component.container.scene.VScene;
import org.visual.model.component.container.scene.VSceneGroup;
import org.visual.model.component.container.scene.VSceneGroupInitParams;
import org.visual.model.component.container.scene.VSceneRole;
import org.visual.model.component.control.CloseButton;
import org.visual.model.component.control.IconifyButton;
import org.visual.model.component.control.MaxResetButton;
...
public class VStage {
    ...
    public VStage(@NotNull Stage stage, VStageInitParams initParams) {
        ...
        if (initParams.maximizeAndResetButton) rootContent.getContentPane().getChildren().add(maxResetButton);
