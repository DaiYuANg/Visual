package org.visual.model.ui.container;
...
public class FrostyBox extends Parent {
     ...
     */
    public FrostyBox(@NotNull FrostyEffect effect, Node child) {
     ...
     */
    private void updateClip(@NotNull Node background, double width, double height) {
        Rectangle clip;
