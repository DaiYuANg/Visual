...
class LabeledDetailPaneInfo extends DetailPaneInfo {
    ...
    @Override protected void updateDetail(final String propertyName) {
        ...
        if (all || propertyName.equals("text")) {
            ...
            textDetail.setDefault(labeled == null || labeled.getText() == null);
        ...
        if (all || propertyName.equals("font")) {
            ...
            fontDetail.setDefault(labeled == null);
            if (!all)
                fontDetail.updated();
            if (!all)
                return;
        ...
        if (all || propertyName.equals("graphic")) {
            ...
            graphicDetail.setDefault(graphic == null);
            if (!all)
        ...
        if (all || propertyName.equals("graphicTextGap")) {
            ...
            graphicTextGapDetail.setDefault(labeled == null || labeled.getGraphic() == null);
        ...
        if (all || propertyName.equals("alignment")) {
            ...
            alignmentDetail.setDefault(labeled == null);
        ...
        if (all || propertyName.equals("textAlignment")) {
            ...
            textAlignmentDetail.setDefault(labeled == null);
        ...
        if (all || propertyName.equals("textOverrun")) {
            ...
            textOverrunDetail.setDefault(labeled == null);
        ...
        if (all || propertyName.equals("contentDisplay")) {
            ...
            contentDisplayDetail.setDefault(labeled == null);
        ...
        if (all || propertyName.equals("underline")) {
            ...
            underlineDetail.setDefault(labeled == null || !labeled.isUnderline());
        ...
        if (all || propertyName.equals("wrapText")) {
            ...
            wrapTextDetail.setDefault(labeled == null || !labeled.isWrapText());
