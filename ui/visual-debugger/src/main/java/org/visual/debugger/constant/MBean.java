...
public enum MBean {
  ...
  G1ConcurrentGC(
      "java.lang:name=G1 Concurrent GC,type=GarbageCollector", GarbageCollectorMXBean.class),
  ...
  G1YoungGeneration(
      "java.lang:name=G1 Young Generation,type=GarbageCollector", GarbageCollectorMXBean.class),
  ...
  G1OldGeneration(
      "java.lang:name=G1 Old Generation,type=GarbageCollector", GarbageCollectorMXBean.class),
  ClassLoading("java.lang:type=ClassLoading", ClassLoadingMXBean.class),
  MetaspaceManager(
      "java.lang:name=Metaspace Manager,type=MemoryManager", MemoryManagerMXBean.class),
  ...
  CodeHeapProfiledNMethods(
      "java.lang:name=CodeHeap 'profiled nmethods',type=MemoryPool", MemoryPoolMXBean.class),
  MappedNonVolatileMemoryBufferPool(
      "java.nio:name=mapped - 'non-volatile memory',type=BufferPool", BufferPoolMXBean.class),
  CodeHeapNonNMethods(
      "java.lang:name=CodeHeap 'non-nmethods',type=MemoryPool", MemoryPoolMXBean.class),
  CompressedClassSpace(
      "java.lang:name=Compressed Class Space,type=MemoryPool", MemoryPoolMXBean.class),
  ...
  CodeHeapNonProfiledNMethods(
      "java.lang:name=CodeHeap 'non-profiled nmethods',type=MemoryPool", MemoryPoolMXBean.class);
