...
public class MiscUtils {
  public static final DateTimeFormatter YYYYMMddHHiissDateTimeFormatter =
  ...
  public static boolean almostEquals(Color a, Color b, double delta) {
    return Math.abs(a.getRed() - b.getRed()) < delta
        && Math.abs(a.getGreen() - b.getGreen()) < delta
        && Math.abs(a.getBlue() - b.getBlue()) < delta;
  }
  ...
  public static Level javaLoggingLevelValueOf(String logLevel) {
    ...
    System.out.println(
        YYYYMMddHHiissDateTimeFormatter.format(ZonedDateTime.now())
            + " SEVERE invalid logLevel: "
            + logLevel
            + ", returning ALL instead");
    return Level.ALL;
  }
}
