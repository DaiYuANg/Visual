...
import org.visual.component.layout.scene.VScene;
import org.visual.component.layout.scene.VSceneGroup;
import org.visual.component.layout.scene.VSceneGroupInitParams;
import org.visual.component.layout.scene.VSceneRole;
...
public class VStage {
  ...
  public VStage(@NotNull Stage stage, VStageInitParams initParams) {
    ...
    SizeUtil.makeClipFor(rootSceneGroup.getNode(), 8);
    ...
    ObserveUtil.observeWidthHeight(
  ...
  private void updateTitlePosition() {
    ...
    var bounds = FxUtil.calculateTextBounds(title);
  ...
  public void setMaximized(boolean maximized) {
    ...
    if (OS.OS == OS.MAC) {
      if (maximized) {
        ...
        val screen = FxUtil.getScreenOf(stage);
        if (screen == null) {
          return;
        }
  ...
  public void temporaryOnTop() {
    ...
    FxUtil.runDelay(500, () -> stage.setAlwaysOnTop(false));
  }
}
