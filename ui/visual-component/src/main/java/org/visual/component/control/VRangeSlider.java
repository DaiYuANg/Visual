...
import org.visual.component.util.EventUtil;
...
public class VRangeSlider extends Pane {
  ...
  public VRangeSlider(SliderDirection sliderDirection) {
    ...
    EventUtil.setOnMouseEntered(buttonMin, e -> labelAnimation.play(labelVisible));
    EventUtil.setOnMouseExited(buttonMin, e -> labelAnimation.play(labelInvisible));
    EventUtil.setOnMouseEntered(buttonMax, e -> labelAnimation.play(labelVisible));
    EventUtil.setOnMouseExited(buttonMax, e -> labelAnimation.play(labelInvisible));
