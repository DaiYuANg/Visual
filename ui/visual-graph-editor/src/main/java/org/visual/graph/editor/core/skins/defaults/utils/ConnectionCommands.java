...
public class ConnectionCommands {
  ...
  public static void addConnection(
    ...
    if (editingDomain != null) {
      ...
      command.append(
          AddCommand.create(
              editingDomain, model, GraphPackage.Literals.GMODEL__CONNECTIONS, connection));
      command.append(
          AddCommand.create(
              editingDomain, source, GraphPackage.Literals.GCONNECTOR__CONNECTIONS, connection));
      command.append(
          AddCommand.create(
              editingDomain, target, GraphPackage.Literals.GCONNECTOR__CONNECTIONS, connection));
