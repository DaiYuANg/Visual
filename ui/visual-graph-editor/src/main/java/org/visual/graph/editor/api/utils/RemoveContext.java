...
/**
 * Context to keep track of the objects to be deleted in a remove operation. This is necessary to
 * prevent creation of remove commands removing the same objects multiple times which will lead to
 * errors.
 *
 * @since 15.02.2019
 */
public final class RemoveContext {
   ...
   * @return {@code true} if no other involved party has created a delete command for the given
  ...
  /**
   * @param pToCheck {@link EObject} to check
   * @return {@code true} any involved party has created a delete command for the given object
