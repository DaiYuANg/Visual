 ...
 *
 * @param <T> A subtype of {@link EObject} that the Skin represents.
 */
public abstract class GSkin<T extends EObject> {
   ...
   * Constructor
   *
   * @param pItem item represented by this skin
   */
   ...
   *
   * <p>This is provided for advanced skin customization purposes only. Use at your own risk.
   *
   ...
   *
   * <p><b>Should not</b> be called directly, the selection state is managed by the selection
   * manager of the graph editor!
   *
   ...
   *
   * <p>This method will be automatically called by the SelectionTracker when needed.
   */
   ...
   *
   * @return a {@link BooleanProperty} containing {@code true} if the skin is selected, {@code
   *     false} if not
   */
   ...
   * INTERNAL API
   *
   * @param pOnPositionMoved internal update hook to be informed when the position has been changed
   */
  ...
  /**
   * INTERNAL API will be called when the position of this skin has been moved
   *
   * @since 16.01.2019
   */
