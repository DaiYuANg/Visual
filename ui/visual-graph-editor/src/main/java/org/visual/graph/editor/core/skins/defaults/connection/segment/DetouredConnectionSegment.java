...
/**
 * A connection segment that draws a detour (a small semicircle) at points where it intersects other
 * connections.
 *
 * <p>Does not look good when a horizontal detour is drawn on directly on top of a vertical detour,
 * i.e. if many connections intersect around the same point.
 */
public class DetouredConnectionSegment extends ConnectionSegment {
   ...
   */
  public DetouredConnectionSegment(
      final Point2D start, final Point2D end, final double[] intersections) {
  ...
  @Override
  protected void drawBetweenIntersections(
