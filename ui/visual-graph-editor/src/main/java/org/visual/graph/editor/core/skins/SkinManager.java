...
public interface SkinManager extends SkinLookup, GraphEditorSkins {
  ...
  /**
   * @param pConnectionLayouter {@link ConnectionLayouter}
   * @since 16.01.2019
   */
   ...
   *
   * @param pNodeToRemove node to remove
   * @since 10.02.2016
   */
   ...
   *
   * @param pConnectorToRemove connector to remove
   * @since 10.02.2016
   */
   ...
   *
   * @param pConnectionToRemove connection to remove
   * @since 10.02.2016
   */
   ...
   *
   * @param pJointToRemove joint to remove
   * @since 10.02.2016
   */
  void removeJoint(final GJoint pJointToRemove);

  /**
   * Calls {@link GNodeSkin#setConnectorSkins(List)} to update a nodes list of connectors.
   *
  ...
  /**
   * Calls {@link GConnectionSkin#setJointSkins(List)} to update a connections list of joints.
   *
   * @param pConnection connection to update
   * @since 17.02.2016
   */
