...
public class ConnectionEventManager {
   ...
   */
  public void setOnConnectionCreated(
      final Function<GConnection, Command> connectionCreatedHandler) {
  ...
  public void setOnConnectionRemoved(
      final BiFunction<RemoveContext, GConnection, Command> connectionRemovedHandler) {
