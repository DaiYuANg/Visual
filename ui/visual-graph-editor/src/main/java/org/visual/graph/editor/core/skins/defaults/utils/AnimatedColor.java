...
public class AnimatedColor {
  ...
  /**
   * -- GETTER -- Gets the CSS property string of the animation.
   *
  ...
  /**
   * -- GETTER -- Gets the interval of the animation.
   *
  ...
  public AnimatedColor(
      final String property, final Color first, final Color second, final Duration interval) {
