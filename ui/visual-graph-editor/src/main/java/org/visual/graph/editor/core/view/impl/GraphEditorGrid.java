...
public class GraphEditorGrid extends Region {
  ...
  private final StyleableObjectProperty<Color> mGridColor =
      new StyleableObjectProperty<Color>(DEFAULT_GRID_COLOR) {
  ...
  private final DoubleProperty mGridSpacing =
      new DoublePropertyBase(GraphEditorProperties.DEFAULT_GRID_SPACING) {
  ...
  /**
   * Creates a new grid manager. Only one instance should exist per {@link DefaultGraphEditor}
   * instance.
   */
   ...
   *
   * <p>Currently only the grid color is styled in this way.
   */
  private static class StyleableProperties {

    private static final CssMetaData<GraphEditorGrid, Color> GRID_COLOR =
        new CssMetaData<GraphEditorGrid, Color>(
