 ...
 */
package org.visual.graph.editor.core.view;

import javafx.scene.layout.Pane;
import javafx.scene.layout.Region;
import org.visual.graph.editor.api.*;
import org.visual.graph.editor.api.utils.GraphEditorProperties;
import org.visual.graph.editor.core.utils.SelectionBox;
import org.visual.graph.editor.core.view.impl.GraphEditorGrid;

/**
 * The {@link Region} that all visual elements in the graph editor are added to.
 *
 * <p>There is one instance of this class per {@link DefaultGraphEditor}. It is the outermost JavaFX
 * node of the editor.
 *
 * <p>The view currently has two layers - a <b>node</b> layer and a <b>connection</b> layer. The
 * node layer is in front. Graph nodes are added to the node layer, while connections, joints, and
 * tails are added to the connection layer. This means nodes will always be in front of connections.
 *
 * <p>Calling toFront() or toBack() on the associated JavaFX nodes will just reposition them inside
...
public class GraphEditorView extends Region {
  ...
  private final Pane mConnectionLayer =
      new Pane() {
   ...
   *
   * @param pConnectionLayouter the graph editor's {@link ConnectionLayouter} instance
   */
   ...
   *
   * @param pNodeSkin the {@link GNodeSkin} instance to be added
   */
   ...
   *
   * @param pConnectionSkin the {@link GConnectionSkin} instance to be added
   */
   ...
   *
   * @param pJointSkin the {@link GJointSkin} instance to be added
   */
   ...
   *
   * @param pTailSkin the {@link GTailSkin} instance to be added
   */
   ...
   *
   * @param pNodeSkin the {@link GNodeSkin} instance to remove
   */
   ...
   *
   * @param pConnectionSkin the {@link GConnectionSkin} instance to remove
   */
   ...
   *
   * @param pJointSkin the {@link GJointSkin} instance to remove
   */
   ...
   *
   * @param pTailSkin the {@link GTailSkin} instance to remove
   */
   ...
   *
   * @param pX the x position of the selection box
   * @param pY the y position of the selection box
   * @param pWidth the width of the selection box
   * @param pHeight the height of the selection box
   */
  public void drawSelectionBox(
      final double pX, final double pY, final double pWidth, final double pHeight) {
