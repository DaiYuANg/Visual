...
public interface IMinimapRenderer<N extends Node> {
   ...
   *
   * @param pNode node
   * @param pX the target pX coordinate location
   * @param pY the target pY coordinate location
   * @param pWidth the target layout bounds pWidth
   * @param pHeight the target layout bounds pHeight
   */
