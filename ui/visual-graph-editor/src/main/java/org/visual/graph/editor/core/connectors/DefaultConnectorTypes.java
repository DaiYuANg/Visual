 ...
 */
package org.visual.graph.editor.core.connectors;
 ...
 *
 * <ol>
 *   <li>Either <b>input</b> or <b>output</b>
 *   <li>Either <b>top</b>, <b>right</b>, <b>bottom</b>, or <b>left</b>
 * </ol>
 *
 * For example <b>left-input</b> defines a connector on the <em>left</em> side of a node, with a
 * triangle point facing <em>into</em> the node.
 */
public final class DefaultConnectorTypes {
  ...
  public static boolean isValid(final String type) {
    final boolean hasSide =
        type != null && (isTop(type) || isRight(type) || isBottom(type) || isLeft(type));
