 ...
 *
 * <ul>
 *   <li>{@link io.github.eckig.grapheditor.model.impl.GConnectorImpl#getId <em>Id</em>}
 *   <li>{@link io.github.eckig.grapheditor.model.impl.GConnectorImpl#getType <em>Type</em>}
 *   <li>{@link io.github.eckig.grapheditor.model.impl.GConnectorImpl#getParent <em>Parent</em>}
 *   <li>{@link io.github.eckig.grapheditor.model.impl.GConnectorImpl#getConnections
 *       <em>Connections</em>}
 *   <li>{@link io.github.eckig.grapheditor.model.impl.GConnectorImpl#getX <em>X</em>}
 *   <li>{@link io.github.eckig.grapheditor.model.impl.GConnectorImpl#getY <em>Y</em>}
 *   <li>{@link io.github.eckig.grapheditor.model.impl.GConnectorImpl#isConnectionDetachedOnDrag
 *       <em>Connection Detached On Drag</em>}
 * </ul>
 *
 * @generated
 */
...
public class GConnectorImpl extends MinimalEObjectImpl.Container implements GConnector {
  ...
  /**
   * The default value of the '{@link #isConnectionDetachedOnDrag() <em>Connection Detached On
   * Drag</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * The cached value of the '{@link #isConnectionDetachedOnDrag() <em>Connection Detached On
   * Drag</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  public void setId(String newId) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(this, Notification.SET, GraphPackage.GCONNECTOR__ID, oldId, id));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, GraphPackage.GCONNECTOR__TYPE, oldType, type));
  }
   ...
   * @generated
   */
  public NotificationChain basicSetParent(GNode newParent, NotificationChain msgs) {
  ...
  public void setParent(GNode newParent) {
    if (newParent != eInternalContainer()
        || (eContainerFeatureID() != GraphPackage.GCONNECTOR__PARENT && newParent != null)) {
      ...
      if (newParent != null)
        msgs =
            ((InternalEObject) newParent)
                .eInverseAdd(this, GraphPackage.GNODE__CONNECTORS, GNode.class, msgs);
      msgs = basicSetParent(newParent, msgs);
      if (msgs != null) msgs.dispatch();
    } else if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, GraphPackage.GCONNECTOR__PARENT, newParent, newParent));
  }
  ...
  public EList<GConnection> getConnections() {
    if (connections == null) {
      connections =
          new EObjectResolvingEList<GConnection>(
              GConnection.class, this, GraphPackage.GCONNECTOR__CONNECTIONS);
    }
    return connections;
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              GraphPackage.GCONNECTOR__CONNECTION_DETACHED_ON_DRAG,
              oldConnectionDetachedOnDrag,
    ...
    switch (eContainerFeatureID()) {
      case GraphPackage.GCONNECTOR__PARENT:
        return eInternalContainer()
            .eInverseRemove(this, GraphPackage.GNODE__CONNECTORS, GNode.class, msgs);
    }
  ...
  public boolean eIsSet(int featureID) {
    return switch (featureID) {
      case GraphPackage.GCONNECTOR__ID -> !Objects.equals(ID_EDEFAULT, id);
      case GraphPackage.GCONNECTOR__TYPE -> !Objects.equals(TYPE_EDEFAULT, type);
      case GraphPackage.GCONNECTOR__PARENT -> getParent() != null;
      case GraphPackage.GCONNECTOR__CONNECTIONS -> connections != null && !connections.isEmpty();
      case GraphPackage.GCONNECTOR__X -> x != X_EDEFAULT;
      case GraphPackage.GCONNECTOR__Y -> y != Y_EDEFAULT;
      case GraphPackage.GCONNECTOR__CONNECTION_DETACHED_ON_DRAG ->
          connectionDetachedOnDrag != CONNECTION_DETACHED_ON_DRAG_EDEFAULT;
