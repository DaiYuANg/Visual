 ...
 *
 * <p>A custom connector validator must implement this interface. It <b>must</b> also provide a
...
public interface GConnectorValidator {
   ...
   *
   * <p>If the pre-validate check fails, the dragged connector will not interact with the
   * dragged-over connector at all.
   *
   ...
   *
   * <p>If both prevalidate and validate checks pass, a new connection will be created of the type
