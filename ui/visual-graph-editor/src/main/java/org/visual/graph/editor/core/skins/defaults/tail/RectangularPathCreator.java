package org.visual.graph.editor.core.skins.defaults.tail;
...
/**
 * Creates a rectangular connection path based on what sides of the nodes the connection starts and
 * ends at.
 */
public class RectangularPathCreator {
   ...
   *
   * <p>Tries to travel outwards from the start and end nodes by at least a minimum amount.
   *
   ...
   */
  private static @NotNull List<Point2D> connectLeftToLeft(
      final @NotNull Point2D start, final @NotNull Point2D end) {
  ...
  /**
   * Connects the start point on the left side of a node to an end point on the right side of a
   * node.
   *
   * @param start the start position
   * @param end the end position
   * @return a list of points connecting the start and end
   */
  private static @NotNull List<Point2D> connectLeftToRight(
      final @NotNull Point2D start, final @NotNull Point2D end) {
   ...
   * @return a list of points connecting the start and end
   */
  private static @NotNull List<Point2D> connectLeftToTop(
      final @NotNull Point2D start, final @NotNull Point2D end) {
  ...
  /**
   * Connects the start point on the left side of a node to an end point on the bottom side of a
   * node.
   *
   * @param start the start position
   * @param end the end position
   * @return a list of points connecting the start and end
   */
  private static @NotNull List<Point2D> connectLeftToBottom(
      final @NotNull Point2D start, final @NotNull Point2D end) {
  ...
  /**
   * Connects the start point on the lerightft side of a node to an end point on the right side of a
   * node.
   *
   * @param start the start position
   * @param end the end position
   * @return a list of points connecting the start and end
   */
  private static @NotNull List<Point2D> connectRightToRight(
      final @NotNull Point2D start, final @NotNull Point2D end) {
   ...
   * @return a list of points connecting the start and end
   */
  private static @NotNull List<Point2D> connectRightToTop(
      final @NotNull Point2D start, final @NotNull Point2D end) {
  ...
  /**
   * Connects the start point on the right side of a node to an end point on the bottom side of a
   * node.
   *
   * @param start the start position
   * @param end the end position
   * @return a list of points connecting the start and end
   */
  private static @NotNull List<Point2D> connectRightToBottom(
      final @NotNull Point2D start, final @NotNull Point2D end) {
  ...
  /**
   * Connects the start point on the top side of a node to an end point on the bottom side of a
   * node.
   *
   * @param start the start position
   * @param end the end position
  ...
  /**
   * Connects the start point on the bottom side of a node to an end point on the bottom side of a
   * node.
   *
   * @param start the start position
   * @param end the end position
