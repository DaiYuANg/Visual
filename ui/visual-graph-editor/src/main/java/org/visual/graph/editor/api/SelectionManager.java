...
public interface SelectionManager {
   ...
   *
   * <p>This list is read-only. Nodes should be selected via {@link #select(EObject)}.
   *
   ...
   *
   * <p>This list is read-only. Connections should be selected via {@link #select(EObject)}.
   *
   ...
   *
   * <p>This list is read-only. Joints should be selected via {@link #select(EObject)}.
   *
  ...
  /**
   * Convenience method to inform if the given object is currently selected. Is functionally
   * equivalent to calling <code>getSelectedItems().contains(object)</code>.
   *
   * @param object
   ...
   *
   * <p>This set is read-only. Items should be selected via {@link #select(EObject)}.
   *
  ...
  /**
   * This method will clear the selection of the given object. If the given object is not selected,
   * nothing will happen.
   *
