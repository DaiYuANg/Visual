 ...
 *
 * <p>The auto-scrolling occurs when the mouse is dragged to the edge of the window. The scrolling
 * rate increases the longer the cursor is outside the window.
 */
@Slf4j
public class AutoScrollingWindow extends PanningWindow {
  ...
  /**
   * -- GETTER -- Gets whether auto-scrolling is enabled.
   *
   * <p>-- SETTER -- Sets whether auto-scrolling is enabled
   *
   * @return {@code true} if auto-scrolling is enabled
   * @param pAutoScrollingEnabled {@code true} to enable auto-scrolling, {@code false} to disable it
   */
  @Setter @Getter private boolean autoScrollingEnabled = true;
   ...
   *
   * <p>Returns null if the cursor is inside the window and no auto-scrolling should occur.
   *
