...
import org.visual.graph.editor.core.skins.defaults.connection.*;
import org.visual.graph.editor.model.GConnection;

/**
 * The default connection skin.
 *
 * <p>Extension of {@link SimpleConnectionSkin} that provides a mechanism for creating and removing
 * joints.
 */
@Slf4j
public class DefaultConnectionSkin extends SimpleConnectionSkin {
  ...
  public DefaultConnectionSkin(final GConnection connection) {
    ...
    cursorOffsetCalculator =
        new CursorOffsetCalculator(connection, path, backgroundPath, connectionSegments);
