 ...
 * </p>
 * <ul>
 *   <li>{@link io.github.eckig.grapheditor.model.impl.GConnectorImpl#getId <em>Id</em>}</li>
 *   <li>{@link io.github.eckig.grapheditor.model.impl.GConnectorImpl#getType <em>Type</em>}</li>
 *   <li>{@link io.github.eckig.grapheditor.model.impl.GConnectorImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link io.github.eckig.grapheditor.model.impl.GConnectorImpl#getConnections <em>Connections</em>}</li>
 *   <li>{@link io.github.eckig.grapheditor.model.impl.GConnectorImpl#getX <em>X</em>}</li>
 *   <li>{@link io.github.eckig.grapheditor.model.impl.GConnectorImpl#getY <em>Y</em>}</li>
 *   <li>{@link io.github.eckig.grapheditor.model.impl.GConnectorImpl#isConnectionDetachedOnDrag <em>Connection Detached On Drag</em>}</li>
 * </ul>
 *
 * @generated
 */
...
public class GConnectorImpl extends MinimalEObjectImpl.Container implements GConnector {
    ...
    public void setParent(GNode newParent) {
        if (newParent != eInternalContainer() || (eContainerFeatureID() != GraphPackage.GCONNECTOR__PARENT && newParent != null)) {
            ...
            if (newParent != null)
                msgs = ((InternalEObject) newParent).eInverseAdd(this, GraphPackage.GNODE__CONNECTORS, GNode.class, msgs);
