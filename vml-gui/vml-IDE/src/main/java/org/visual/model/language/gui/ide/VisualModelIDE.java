...
public class VisualModelIDE extends Application {
    ...
    public void init() {
        ...
        Boolean theme = Boolean.parseBoolean(Toolkit.getDefaultToolkit().getDesktopProperty("win.xpstyle.themeActive").toString());
        Application.setUserAgentStylesheet(theme ? new PrimerDark().getUserAgentStylesheet() : new PrimerLight().getUserAgentStylesheet());
