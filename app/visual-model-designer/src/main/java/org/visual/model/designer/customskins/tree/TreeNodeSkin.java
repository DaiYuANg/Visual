/* (C)2005-2014*/
package org.visual.model.designer.customskins.tree;
...
public class TreeNodeSkin extends GNodeSkin {
    ...
    public TreeNodeSkin(final GNode node) {
        ...
        background
                .widthProperty()
                .bind(border.widthProperty()
                        .subtract(border.strokeWidthProperty().multiply(2)));
        background
                .heightProperty()
                .bind(border.heightProperty()
                        .subtract(border.strokeWidthProperty().multiply(2)));
    ...
    public void setConnectorSkins(final List<GConnectorSkin> connectorSkins) {
        ...
        for (final GConnectorSkin skin : connectorSkins) {
            ...
            } else if (TreeSkinConstants.TREE_INPUT_CONNECTOR.equals(
                    skin.getItem().getType())) {
