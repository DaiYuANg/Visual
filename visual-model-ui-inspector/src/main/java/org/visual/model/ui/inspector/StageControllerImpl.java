...
import lombok.val;
import org.visual.model.ui.inspector.details.AllDetails;
import org.visual.model.ui.inspector.details.DetailPaneType;
import org.visual.model.ui.inspector.event.*;
import org.visual.model.ui.inspector.gui.ComponentHighLighter;
import org.visual.model.ui.inspector.gui.RuleGrid;
import org.visual.model.ui.util.NodeUtil;
import org.visual.model.ui.inspector.helper.StyleSheetRefresher;
import org.visual.model.ui.inspector.helper.SubWindowChecker;
...
import org.visual.model.ui.inspector.node.NodeType;
import org.visual.model.ui.inspector.node.SVDummyNode;
import org.visual.model.ui.inspector.node.SVNode;
import org.visual.model.ui.inspector.node.SVNodeFactory;
...
//                }
    ...
    private void addNewNode(final Node node) {
        if (SCUtils.isNormalNode(node)) {
            ...
            dispatchEvent(new NodeAddRemoveEvent(FXConnectorEvent.SVEventType.NODE_ADDED, getID(), svNode));
        }
    }
    ...
    private void removeNode(final Node node, final boolean removeVisibilityListener) {
        if (SCUtils.isNormalNode(node)) {
            ...
            dispatchEvent(new NodeAddRemoveEvent(FXConnectorEvent.SVEventType.NODE_REMOVED, getID(), createNode(node)));
        }
    }
