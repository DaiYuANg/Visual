...
import org.visual.model.ui.inspector.model.Persistence;
import org.visual.model.ui.inspector.model.update.AppsRepository;
import org.visual.model.ui.inspector.model.update.UpdateStrategy;
import org.visual.model.ui.inspector.node.SVNode;
import org.visual.model.ui.inspector.view.control.FilterTextField;
import org.visual.model.ui.inspector.view.dialog.AboutBox;
import org.visual.model.ui.inspector.view.dialog.HelpBox;
import org.visual.model.ui.inspector.view.tabs.*;
...
//        checkNewVersion(false);
    ...
    private void buildFiltersBox() {
        ...
        activeNodeFilters.add(new NodeFilter() {
            ...
            @Override
            public boolean accept(final SVNode node) {
                if (idFilterField.getText().isEmpty())
                    return true;
                return node.getId() != null && node.getId().toLowerCase().contains(idFilterField.getText().toLowerCase());
            }
        ...
        activeNodeFilters.add(new NodeFilter() {
            ...
            @Override
            public boolean accept(final SVNode node) {
                if (classNameFilterField.getText().isEmpty())
                    return true;

                // Allow reduces or complete className
                return node.getNodeClass().toLowerCase().contains(classNameFilterField.getText().toLowerCase());
            }
