...
class GridPaneDetailPaneInfo extends DetailPaneInfo {
    ...
    @Override protected void createDetails() {
        ...
        rowConstraintsDetail = addDetail("rows", "rowConstraints:", Detail.ValueType.GRID_CONSTRAINTS);
        columnConstraintsDetail = addDetail("columns", "columnConstraints:", Detail.ValueType.GRID_CONSTRAINTS);
    ...
    @Override protected void updateDetail(final String propertyName) {
        ...
        if (all || propertyName.equals("hgap") || propertyName.equals("vgap")) {
            ...
            gapDetail.setDefault(gridpane == null || (gridpane.getHgap() == 0 && gridpane.getVgap() == 0));
        ...
        if (all || propertyName.equals("alignment")) {
            ...
            alignmentDetail.setDefault(gridpane == null || gridpane.getAlignment() == Pos.TOP_LEFT);
        ...
        if (all || propertyName.equals("gridLinesVisible")) {
            ...
            gridLinesVisibleDetail.setDefault(gridpane == null || !gridpane.isGridLinesVisible());
