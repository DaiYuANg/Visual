 ...
 */
package org.visual.model.ui.inspector.view.dialog;
...
import org.visual.model.ui.inspector.view.control.ProgressWebView;
...
public class HelpBox {
    ...
    public static @NotNull HelpBox make(final String title, final String url, final @NotNull Stage stage) {
        DisplayUtils.showWebView(true);
        return new HelpBox(title, url, stage.getX() + (stage.getWidth() / 2) - ((double) SCENE_WIDTH / 2), stage.getY() + (stage.getHeight() / 2) - ((double) SCENE_HEIGHT / 2));
    }
}
