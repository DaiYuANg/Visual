 ...
 */
package org.visual.model.ui.inspector.module.api;
...
public class URIToPathConverters {
    private static final Function<String, Path> MAVEN_RESOURCE = uri -> {
    ...
    private static final String[] JAR_SOURCES_REPLACEMENTS = {"src/main/java", "src/main/resources", "src/test/java", "src/test/resources"};
