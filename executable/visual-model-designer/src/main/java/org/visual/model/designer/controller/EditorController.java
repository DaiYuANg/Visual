package org.visual.model.designer.controller;
...
import org.visual.model.designer.core.GraphEditorPersistence;
import org.visual.model.designer.customskins.DefaultSkinController;
import org.visual.model.designer.customskins.SkinController;
import org.visual.model.designer.customskins.TitledSkinController;
import org.visual.model.designer.customskins.TreeSkinController;
import org.visual.model.designer.customskins.titled.TitledSkinConstants;
import org.visual.model.designer.customskins.tree.TreeConnectorValidator;
import org.visual.model.designer.customskins.tree.TreeSkinConstants;
...
public class EditorController implements Initializable {
    ...
    @FXML
    private Button clearConnectorsButton;

    @FXML
    private RadioButton inputConnectorTypeButton;

    @FXML
    private RadioButton outputConnectorTypeButton;

    @FXML
    private RadioButton leftConnectorPositionButton;

    @FXML
    private RadioButton rightConnectorPositionButton;

    @FXML
    private RadioButton topConnectorPositionButton;

    @FXML
    private RadioButton bottomConnectorPositionButton;

    @FXML
    private RadioButton showGridButton;

    @FXML
    private RadioButton snapToGridButton;

//    @FXML
//    private Menu readOnlyMenu;

    @FXML
    private RadioButton defaultSkinButton;

    @FXML
    private RadioButton treeSkinButton;

    @FXML
    private RadioButton titledSkinButton;

//    @FXML
//    private Menu intersectionStyle;

    @FXML
    private RadioButton gappedStyleButton;

    @FXML
    private RadioButton detouredStyleButton;
    ...
    private final SimpleObjectProperty<SkinController> activeSkinController = new SimpleObjectProperty<>() {
