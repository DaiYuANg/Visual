package org.visual.model.designer.context
...
import org.visual.model.designer.core.VisualModelUI
...
data object ApplicationContext {
  ...
  fun load(prefix: String): Parent {
    val loader = FXMLLoader(VisualModelUI::class.java.getResource("$prefix.fxml"))
