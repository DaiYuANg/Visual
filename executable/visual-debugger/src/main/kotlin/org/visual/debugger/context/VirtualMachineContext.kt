...
import org.visual.debugger.util.jmxPropertiesBuilder
...
data object VirtualMachineContext {
  ...
  var virtualMachine: VirtualMachine?
    get() = _virtualMachine.get()
    set(value) = _virtualMachine.set(value)
  ...
  fun isAttached(): Boolean {
    return _virtualMachine.isNotNull.get()
  }

  fun isNotAttached(): Boolean {
    return _virtualMachine.isNull.get()
  }

  fun refreshVMS() {
    virtualMachines.clear().run { virtualMachines.addAll(VirtualMachine.list()) }
  }
}
