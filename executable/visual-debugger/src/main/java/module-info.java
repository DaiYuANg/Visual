...
module org.visual.debugger {
    ...
    opens org.visual.debugger.view.cssfx to javafx.fxml;
    opens org.visual.debugger.view.threedom to javafx.fxml;
    opens org.visual.debugger.remote to java.instrument, java.rmi;
    opens org.visual.debugger.component to javafx.fxml;
    opens org.visual.debugger.controller to javafx.fxml;
    ...
    provides io.avaje.inject.spi.Module with org.visual.debugger.DebuggerModule;
}
