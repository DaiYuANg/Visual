...
public class LayoutController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        splitPane.setDividerPosition(0, Objects.requireNonNull(preferences.get(PreferencesKey.SPLIT_DIVIDER.getValue(), 0.2)));
...
//        });
    ...
    void onShutdown(){
        ...
        preferences.put(PreferencesKey.SPLIT_DIVIDER.getValue(), splitPane.getDividers().getFirst().getPosition());
        preferences.flush();
    }
}
