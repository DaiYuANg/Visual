...
public class TreeNodeSkin extends GNodeSkin {
  ...
  private static final String STYLE_CLASS_SELECTION_HALO =
      "tree-node-selection-halo"; // $NON-NLS-1$
  private static final String STYLE_CLASS_BUTTON = "tree-node-button"; // $NON-NLS-1$

  private static final PseudoClass PSEUDO_CLASS_SELECTED =
      PseudoClass.getPseudoClass("selected"); // $NON-NLS-1$
  ...
  private void addButton() {
    ...
    addChildButton.setGraphic(new FontIcon(FontAwesomeSolid.PLUS));
  ...
  private void addChildNode() {
    ...
    // Set the rest of the values via EMF commands because they touch the currently-edited
    // model.
   ...
   *
   * <p>Assumes the node has 1 or 2 connectors, and if there are 2 connectors the second is the
   * output. Bit dodgy but only used in the demo.
   */
