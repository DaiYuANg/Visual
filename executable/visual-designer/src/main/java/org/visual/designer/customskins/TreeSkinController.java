...
import org.visual.designer.customskins.tree.*;
import org.visual.designer.selections.SelectionCopier;
import org.visual.graph.editor.api.*;
import org.visual.graph.editor.core.skins.defaults.DefaultConnectionSkin;
...
public class TreeSkinController implements SkinController {
  ...
  private GNodeSkin createSkin(final GNode node) {
    return TreeSkinConstants.TREE_NODE.equals(node.getType())
        ? new TreeNodeSkin(node)
