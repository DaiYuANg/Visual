...
public class JDBCUtil {
    ...
    @SneakyThrows
    public static @NotNull Set<DatabaseTableColumn> listColumns(@NonNull Connection conn, @NonNull String tableName) {
        ...
        while (getColumns.next()) {
            val col = DatabaseTableColumn.builder()
    ...
    @SneakyThrows
    public static @NotNull Set<String> listPrimaryKeys(@NonNull Connection conn, @NonNull String tableName) {
