...
public interface NSDistributedNotificationCenter extends NSObject {
    ...
    void addObserver(
            ID observer,
            @NamedArg("selector") Pointer aSelector,
            @NamedArg("name") NSNotificationName aName,
            @NamedArg("object") NSString anObject);
    ...
    void postNotificationName(
            ...
            @NamedArg("object") NSString object,
            @NamedArg("userInfo") NSDictionary<?, ?> userInfo,
            @NamedArg("deliverImmediately") boolean deliverImmediately);
