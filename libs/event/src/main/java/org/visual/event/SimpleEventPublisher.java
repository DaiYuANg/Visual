...
public class SimpleEventPublisher implements EventPublisher {
  ...
  private final SetMultimap<Class<? extends AbstractEvent>, EventListener<? extends AbstractEvent>>
      listeners;
  ...
  @Override
  public <E extends AbstractEvent> void addListener(
      @NotNull Collection<ListenerArgument<E>> listenerArguments) {
