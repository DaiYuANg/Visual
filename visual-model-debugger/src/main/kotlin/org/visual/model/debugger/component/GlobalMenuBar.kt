...
class GlobalMenuBar
    @JvmOverloads
    constructor(var exitHandle: EventHandler<ActionEvent>? = null) :
    MenuBar() {
        ...
        private val showBoundsCheckbox by lazy {
            ...
            menuItem.selectedProperty()
                .addListener { arg0: ObservableValue<out Boolean>?, arg1: Boolean?, newValue: Boolean ->
//                setStatusText(
...
//            )
        ...
        private val aboutMenu: Menu by lazy {
            Menu("Help").apply {
                items.add(aboutItem)
            }
        }
