...
public class InsetsDisplay extends Region {
    ...
    protected void storeInsets(final Insets value) {
        insets = value;
        topText.setText(insets != null ? DisplayUtils.DFMT.format(insets.getTop()) : "-");
        bottomText.setText(insets != null ? DisplayUtils.DFMT.format(insets.getBottom()) : "-");
        leftText.setText(insets != null ? DisplayUtils.DFMT.format(insets.getLeft()) : "-");
        rightText.setText(insets != null ? DisplayUtils.DFMT.format(insets.getRight()) : "-");
        requestLayout();
    }
