...
class TextDetailPaneInfo extends DetailPaneInfo {
    ...
    protected void updateDetail(final @NotNull String propertyName) {
        ...
        if (all || propertyName.equals("content")) {
            ...
            contentDetail.setDefault(textnode == null || textnode.getText() == null);
        ...
        if (all || propertyName.equals("font")) {
            ...
            fontDetail.setDefault(textnode == null);
            if (!all)
                fontDetail.updated();
            if (!all)
                return;
        ...
        if (all || propertyName.equals("textOrigin")) {
            ...
            originDetail.setDefault(textnode == null);
        ...
        if (all || propertyName.equals("x") || propertyName.equals("y")) {
            ...
            xyDetail.setDefault(textnode == null || (textnode.getX() == 0 && textnode.getY() == 0));
        ...
        if (all || propertyName.equals("textAlignment")) {
            ...
            alignmentDetail.setDefault(textnode == null);
        ...
        if (all || propertyName.equals("textBoundsType")) {
            ...
            boundsTypeDetail.setDefault(textnode == null || textnode.getBoundsType() == TextBoundsType.LOGICAL);
        ...
        if (all || propertyName.equals("wrappingWidth")) {
            ...
            wrappingWidthDetail.setDefault(textnode == null || textnode.getWrappingWidth() == 0);
        ...
        if (all || propertyName.equals("underline")) {
            ...
            underlineDetail.setDefault(textnode == null || !textnode.isUnderline());
        ...
        if (all || propertyName.equals("strikethrough")) {
            ...
            strikethroughDetail.setDefault(textnode == null || !textnode.isStrikethrough());
