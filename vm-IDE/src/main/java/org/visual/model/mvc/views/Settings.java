...
import org.visual.model.mvc.controllers.TestStarter;
...
public enum Settings {
    ...
    private final StringProperty stringProperty = new SimpleStringProperty("String");
    private final BooleanProperty booleanProperty = new SimpleBooleanProperty(true);
    private final IntegerProperty integerProperty = new SimpleIntegerProperty(12);
    private final DoubleProperty doubleProperty = new SimpleDoubleProperty(6.5);

    Settings() {
        settings = PreferencesFx.of(TestStarter.class, // Save class (will be used to reference saved values of Settings to)
